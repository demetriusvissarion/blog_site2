...
<head>
	...
	<link rel="shortcut icon" href="/wp-content/themes/blog_site2/assets/images/logo.png">
	...
	<!-- Theme CSS -->
	<!-- <link rel="stylesheet" href="/wp-content/themes/blog_site2/assets/css/style.css"> -->
...
<body>
	...
	<header class="header text-center">
		...
		<nav class="navbar navbar-expand-lg navbar-dark">
			...
			<div id="navigation" class="collapse navbar-collapse flex-column">
				<img class="mb-3 mx-auto logo" src="/wp-content/themes/blog_site2/assets/images/logo.png" alt="logo">
	...
	<div class="main-wrapper">
				...
				<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="/wp-content/themes/blog_site2/assets/images/slider2.jpg" class="d-block w-100" alt="1">
						</div>
						<div class="carousel-item">
							<img src="/wp-content/themes/blog_site2/assets/images/slider1.jpg" class="d-block w-100" alt="2">
						</div>
						<div class="carousel-item">
							<img src="/wp-content/themes/blog_site2/assets/images/slider3.jpg" class="d-block w-100" alt="3">
						</div>
					</div>
		...
		<footer class="footer text-center py-2 theme-bg-dark">
			...
			<p class="copyright"><a href="#">Copyright 2023</a></p>
	...
	<!-- <script src="/wp-content/themes/blog_site2/assets/js/main.js"></script> -->
